...
class Pspnet(nn.Module):
    def __init__(self, num_classes):
        ...
        # )
        self.backbone = timm.create_model('resnet50.fb_swsl_ig1b_ft_in1k', features_only=True, output_stride=8,
                                          out_indices=(1, 2, 3, 4), pretrained=True, in_chans=4)
...
if __name__ == "__main__":
    ...
    model = model.cuda()
    model.train()
    a = torch.randn(1, 4, 512, 512).cuda()
